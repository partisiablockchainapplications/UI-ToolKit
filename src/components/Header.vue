  ...
  <header style="z-index: 10" class="bg-gray-50 px-5 py-5 lg:px-8 text-white border-b border-white sticky top-0">
    <div class="flex items-center justify-between max-w-7xl m-auto">
      ...
      <div class="flex flex-row">
        ...
        >
          <span class="web3-span text-sm sm:text-lg text-black font-bold px-4 py-4 sm10">CONNECT PARTISIA WALLET</span>
        </a>
      </div>
    </div>
  </header>
...
export default {
  ...
  methods: {
    ...
    openContractDocumentation(){
      window.open('https://partidev.surge.sh/', '_blank')
    },
    openDeployContract() {
